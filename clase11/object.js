...
​
onsole.log(object);
console.log(arraySkillers2);
console.table(arraySkillers2);
​
console.warn("NO SEAN ANSIOSOS");
console.error("TE APURASTE MAS DE LA CUENTA");
​
console.log(arraySkillers2[9]);
​
...
// }
​
const arraySkillers3 = ["Adrian", "Williams", "Gonzalo", "Sofía", "Mariano"];
console.log(arraySkillers3.slice(3));